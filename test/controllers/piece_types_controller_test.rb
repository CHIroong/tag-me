...
class PieceTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece_type" do
    assert_difference('PieceType.count') do
      post piece_types_url, params: { piece_type: { piece_id: @piece_type.piece_id, type_id: @piece_type.type_id } }
    end
  ...
  test "should update piece_type" do
    patch piece_type_url(@piece_type), params: { piece_type: { piece_id: @piece_type.piece_id, type_id: @piece_type.type_id } }
